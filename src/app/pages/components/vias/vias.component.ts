...
export class ViasComponent  {
  ...
  validarVacios(): boolean {
    let chrcurcodigo = this.viaHabUrb.CHRCURCODIGO;
    let intcercodigo = this.viaHabUrb.INTTCUCODIGO;
    let vchviadescripcion = this.viaHabUrb.VCHVIADESCRIPCION;
    let vchtvidescripcion = this.viaHabUrb.VCHTVIDESCRIPCION;
    let vchviacodigo = this.viaHabUrb.VCHVIACODIGO;
    let vchcurdescripcion = this.viaHabUrb.VCHCURDESCRIPCION;
    let vchtcudescripcion = this.viaHabUrb.VCHTCUDESCRIPCION;
    let inttvicodigo = this.viaHabUrb.INTTVICODIGO;
